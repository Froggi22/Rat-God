...
module.exports = {
	...
	execute (interaction) {
		...
		case 'factory':
			switch (data2) {
			case null:
				embedNull.setImage(confX.mapsFactoryNullImage)
				embedNull.addField('Type "/Maps Factory Info" to get detailed info about the area', 'Detailed map: **/Maps Factory Map**‎\nInteractive map: **/Maps Factory Interactive Map**')
				break
			...
			case 'Map':
				embedMap.setImage(confX.mapsFactoryMapImage)
				embedMap.addField('Type "/Maps Factory Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case 'Interactive Map':
				embedIM.setDescription('[A **very** useful Factory map](https://tarkov-tools.com/map/factory)')
				embedIM.addField('Type "/Maps Factory Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			}
			break
		case 'woods':
			switch (data2) {
			case null:
				embedNull.setImage(confX.mapsWoodsNullImage)
				embedNull.addField('Type "/Maps Woods Info" to get detailed info about the area', 'Detailed map: **/Maps Woods Map**\nGuide for hidden stashes: **/Maps Woods Hidden Stashes**\nInteractive map: **/Maps Woods Interactive Map**'); break
			case 'Info':
				...
				break
			case 'Map':
				embedMap.setImage(confX.mapsWoodsMapImage)
				embedMap.addField('Type "/Maps Woods Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case 'Hidden Stashes':
				embedHS.setImage(confX.mapsWoodsHSImage)
				embedHS.addField('Type "/Maps Woods Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case 'Interactive Map':
				embedIM.setDescription('[A **very** useful Woods map](https://tarkov-tools.com/map/woods)')
				embedIM.addField('Type "/Maps Woods Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			}
			break
		case 'customs':
			switch (data2) {
			case null:
				embedNull.setImage(confX.mapsCustomsNullImage)
				embedNull.addField('Type "/Maps Customs Info" to get detailed info about the area', 'Detailed map: **/Maps Customs Map**\nGuide for hidden stashes: **/Maps Customs Hidden Stashes**\nInteractive map: **/Maps Customs Interactive Map**\nDorms map: **/Maps Customs Dorms**\n3D map: **/Maps Customs 3D**'); break
			case 'Info':
			...
			case 'Map':
				embedMap.setImage(confX.mapsCustomsMapImage)
				embedMap.addField('Type "/Maps Customs Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case 'Hidden Stashes':
				embedHS.setImage(confX.mapsCustomsHSImage)
				embedHS.addField('Type "/Maps Customs Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case 'Interactive Map':
				embedIM.setDescription('[A **very** useful Customs map](https://tarkov-tools.com/map/customs)')
				embedIM.addField('Type "/Maps Customs Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case 'Dorms Map':
				embedCustom.setTitle('Customs Dorms Map')
				embedCustom.setDescription('Dorms guide')
				embedCustom.setImage(confX.mapsCustomsDormsImage)
				embedCustom.addField('Type "/Maps Customs Info" to get detailed info about the area', 'Made for **0.12.11**‎\nMap is still valid.')
				break
			case '3D Map':
				embedCustom.setTitle('3D Customs Map')
				embedCustom.setDescription('A useful 3D Customs map')
